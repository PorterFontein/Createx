(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        var eventCalllback = function(e) {
            var el = e.target, clearVal = el.dataset.phoneClear, pattern = el.dataset.phonePattern, matrix_def = "+_(___) ___-__-__", matrix = pattern ? pattern : matrix_def, i = 0, def = matrix.replace(/\D/g, ""), val = e.target.value.replace(/\D/g, "");
    ...
    function initSliders() {
        ...
        if (document.querySelector(".portfolio-page__slider")) new core(".portfolio-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            loop: true,
            navigation: {
                prevEl: ".portfolio-page__arrow-prev",
                nextEl: ".portfolio-page__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".testimonials-page__slider")) new core(".testimonials-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".testimonials-page__arrow-prev",
                nextEl: ".testimonials-page__arrow-next"
            },
            on: {}
        });
        if (document.querySelector(".project-page__slider-thumbs")) {
            const thumbsSwiper = new core(".project-page__slider-thumbs", {
            ...
            new core(".project-page__slider-main", {
                modules: [ Navigation, Thumb ],
                thumbs: {
                    swiper: thumbsSwiper
                },
                ...
                speed: 800,
                navigation: {
                    prevEl: ".project-page-button-prev",
                    nextEl: ".project-page-button-next"
                },
                on: {}
            });
        }
